    ...
    <aside className="rounded-3xl ml-6 p-6 pt-20 mt-[73px] shadow-xl bg-violet-200 w-[320px] text-violet-900 border-violet-300 border-2 sticky top-[155px] ">
      ...
      <div className="flex justify-center mt-2">
        <div className="mb-[-15px]">
          ...
          {userData.stars < 10 ?  <p className="relative top-[-36px] left-[19px] font-bold text-white"> {userData.stars}</p> : <p className="relative top-[-35px] left-[16px] font-bold text-white">  {userData.stars}</p>
          } 
        </div>
      </div>
