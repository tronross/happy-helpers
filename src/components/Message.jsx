export default function Message({ message, handleDelete }) {
  ...
  return (
    <section className="text-teal-600 text-xs relative font-normal">
      <p className="mb-1 font-semibold">{messageTime.toLocaleString('en-us', {weekday:"short", year:"numeric", month:"short", day:"numeric", hour:"2-digit", minute:"2-digit"})}</p>
      <p className="mb-1 font-medium uppercase">{message.subject}</p>
