...
export default function Message({ message, handleDelete }) {
  ...
  return (
    <section className="text-xs relative font-normal">
      ...
      <svg className="w-5 h-5 absolute top-1 right-1 hover:cursor-pointer text-violet-400 hover:text-violet-500" onClick={() => handleDelete(message.id)} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
